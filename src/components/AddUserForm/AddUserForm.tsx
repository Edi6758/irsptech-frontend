    ...
    try {
      if (initialValues && initialValues.id != null) {
        const response = await axios.put(
          `https://my-json-server.typicode.com/Edi6758/irsptech-frontend/users/${initialValues.id}`,
          data,
        );
        ...
        const response = await axios.post(
          "https://my-json-server.typicode.com/Edi6758/irsptech-frontend/users",
          data,
        );
  ...
  return (
    <>
      ...
      <s.FormContainer onSubmit={handleSubmit(onSubmit)}>
        ...
        <label>Suite:</label>
        <input
          {...register("address.suite", { required: "Suite is required" })}
          defaultValue={initialValues.address.suite}
        />
        ...
        <input
          ...
          defaultValue={initialValues.address.zipcode}
        />
        ...
        <input
          {...register("company.catchPhrase", {
            required: "Company Catch Phrase is required",
          })}
          defaultValue={initialValues.company.catchPhrase}
        />
        ...
        <input
          ...
          defaultValue={initialValues.company.bs}
        />
